...
POST: http://localhost:3001/api/search/person
{
  "name": "Spencer Feig",
  "email": "spencer@flashai.us",
  "search_providers": ["brave", "serpapi"],
  "include_plan": true,
  "plan_provider": "google",
  "extra_context": "Looking for current role and public speaking engagements."
}